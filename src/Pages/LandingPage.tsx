...
const LandingPage = () => {
    ...
    return (
        <div>
            <Header/>
            {/* hero section */}
            <div className="h-screen w-full flex flex-row justify-between px-20 items-center " >
                {/* left */}
                <div data-aos="fade-right" className="flex flex-col gap-5 w-[50%]">
                    <div className="flex flex-col  gap-6" >
                        ...
                        <p className="text-text-weak w-[80%] text-lg">
            ...
            {/* Tools */}
            <div className="p-20 bg-bg-2">
                <div data-aos="fade-up">
                    <div className="flex flex-col justify-center items-center">
                        <p className="text-text-strong text-3xl font-bold">Tools for Every Journey</p>
                        <p className="text-text-weak w-[50%] text-center mt-3">A comprehensive ecosystem designed to handle everything from scheduling to sophisticated AI-assisted learning</p>
                    </div>
                </div>
            ...
            <div className="p-20">
                <div data-aos="fade-up">
                    <div className="flex flex-col justify-center items-center">
                        <p className="text-text-strong text-3xl font-bold">Your Path To Mastery</p>
                    </div>
                        ...
                        {steps.map((step)=>(
                            <div key={step.id} data-aos="fade-up" data-aos-delay={(step.id-1)*100}>
                                <div className="flex flex-col h-full justify-center gap-2 items-center relative">
                                    ...
                                    <p className="text-text-strong text-2xl mt-3">{step.title}</p>
                                    <p className="text-text-weak mt-3 w-[80%] text-center">{step.description}</p>
                                    <span className="w-full h-0.5 absolute top-[25%] -left-2 bg-gray-300/70"/>
                                </div>
                            </div>
                        ))}
                    </div>
